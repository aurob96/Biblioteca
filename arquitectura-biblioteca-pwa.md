...
Stack recomendado: Node.js + Express + TypeScript + Prisma + PostgreSQL. La API sera REST, documentada con OpenAPI/Swagger.
...
- `vite-plugin-pwa`: service worker, manifest y modo instalable.
